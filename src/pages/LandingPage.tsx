        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="text-[11px] bg-slate-950/20 px-1.5 py-0.5 rounded font-mono">9.57 MB</span>
            </a>
          </div>
        </div>
      </header>
        ...
        <section className="pt-16 pb-20 sm:pt-24 sm:pb-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
            ...
            >
              ...
              <span className="text-xs px-2 py-0.5 rounded-md bg-slate-950/20 font-mono font-bold">9.57 MB</span>
            </a>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-y-2 gap-x-6 text-xs text-slate-400 font-mono">
            ...
            <span>Size: <strong className="text-slate-200 font-semibold">9.57 MB</strong></span>
            <span className="hidden sm:inline">•</span>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              ...
              <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
                ...
                <div className="text-base font-bold text-emerald-400 mt-1 font-mono">9.57 MB</div>
              </div>
              <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                <div className="flex gap-4">
                  ...
                  <div className="text-xs text-slate-300 leading-relaxed">
                    Click <strong>Download Android APK (9.57 MB)</strong> to download the APK directly to your phone.
                  </div>
                </div>
                <div className="flex gap-4">
          ...
          <div className="rounded-3xl bg-gradient-to-r from-emerald-900/30 via-slate-900 to-teal-900/30 border border-emerald-500/20 p-10 sm:p-16 max-w-4xl mx-auto">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              >
                ...
                <span>Download APK (9.57 MB)</span>
              </a>
