...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 pb-safe">
      ...
      <div className="mx-auto max-w-lg glass-modal h-16 shadow-[0_-8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_-8px_30px_rgb(0,0,0,0.2)] rounded-t-[24px] flex items-center justify-between px-4 transition-all duration-300">
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex-1 py-1.5 flex flex-col items-center justify-center transition-all duration-200 cursor-pointer relative ${
                isActive 
